		...
		<div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <strong>广告类型列表</strong>
                    </li>
                </ol>
            </div>              
        </div>
        <br />
		<a href="<?php echo U('Advert/addtype');?>" class="btn btn-primary">添加广告类型</a>
		<br />
		<br />
		<div class="row">
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5><i class="fa fa-tasks"></i> 广告类型管理</h5>
					</div>
						...
						<table class="table table-bordered">
							...
							<tbody>
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="long-td">
										...
										<td width="30%">
											<a href="<?php echo U('advert/edittype',array('id'=>$vo['id']));?>" class="btn btn-primary btn-mini">
												<i class="fa fa-pencil"></i> 编辑</a>&nbsp;&nbsp;
											<a onClick="return confirm('是否删除此条记录')" href="<?php echo U('advert/deltype',array('id'=>$vo['id']));?>" class="btn btn-danger">
