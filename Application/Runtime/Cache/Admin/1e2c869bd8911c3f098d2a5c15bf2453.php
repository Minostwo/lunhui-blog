...
$(document).ready(function(){
	$("#loginout").click(function(){
        ...
        <br />
		<a href="<?php echo U('Link/add');?>" class="btn btn-primary">添加链接</a>
		<br />
		<br />
		<div class="row">
			<div class="col-sm-12">
						...
						<table class="table table-bordered">
							...
							<tbody>
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="long-td">
                                        ...
                                        <td><?php echo (date('Y年m月d日 H:i:s',$vo["update_time"])); ?></td>
                                        <td>
										...
										<td>
											<a href="<?php echo U('Link/edit',array('id'=>$vo['id']));?>" class="btn btn-primary">
...
<script>
	...
	function del(id){
		    ...
		    layer.close(index);
		    window.location.href="/Admin/Link/del/id/"+id+"";
		});
	}
