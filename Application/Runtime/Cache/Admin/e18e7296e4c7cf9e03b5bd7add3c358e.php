...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
	...
	<link href="/Public/Admin/css/plugins/switchery/switchery.css" rel="stylesheet"><!--IOS开关样式-->	 
			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<input type="hidden" name="s_id" value="<?php echo ($detail["s_id"]); ?>" />							
							<div class="form-group">
                                <label class="col-sm-2 control-label">内容：</label>
                                <div class="col-sm-10">
                                    <script type="text/plain" id="editor" name="s_content" style="width:78%;height:200px;"><?php echo (stripslashes(htmlspecialchars_decode($detail["s_content"]))); ?></script>
                                </div>
                            </div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div class="radio">
										<?php if($detail['s_view'] == 1 ): ?><input type="checkbox" name='s_view' value="1" class="js-switch" checked />
	                        			<?php else: ?>
	                        				<input type="checkbox" name='s_view' value="1" class="js-switch" /><?php endif; ?>
	                        		</div>
								</div>
							</div>
                            <div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="s_writer" id="s_writer" value="<?php echo ($detail["s_writer"]); ?>" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-2">
									...
									<a class="btn btn-white" href="<?php echo U('Said/index');?>">取消</a>
								</div>
							</div>
						</form>
					</div>
