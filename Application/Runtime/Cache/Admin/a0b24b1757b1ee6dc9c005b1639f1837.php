			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form action="<?php echo U('runedittype');?>" method="post" class="form-horizontal" id="signupForm">
						<input type="hidden" name="cate_id" value="<?php echo ($detail["cate_id"]); ?>" />
							<div class="form-group">
								<label class="col-sm-2 control-label">分类名称</label>
								<div class="col-sm-6">
									<input type="text" name="cate_name" value="<?php echo ($detail["cate_name"]); ?>" placeholder="输入分类名称" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="orderby" value="<?php echo ($detail["orderby"]); ?>" placeholder="输入排序"  class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-2">
									...
									<a class="btn btn-danger" href="<?php echo U('Article/indextype');?>">取消</a>
								</div>
							</div>
						</form>
					</div>
