			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form class="form-horizontal" method="post" action="<?php echo U('runedit',array('id'=>$detail['id']));?>" name="signupForm" id="signupForm">	
							<input type="hidden" name="id" value="<?php echo ($detail["id"]); ?>" />
							<div class="form-group">
                                <label class="col-sm-2 control-label">名称</label>
                                <div class="col-sm-6">
                                    <input type="text" name="name" id="name" value="<?php echo ($detail["name"]); ?>" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="url" id="url" value="<?php echo ($detail["url"]); ?>" class="form-control">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div class="radio">
										<?php if($detail['state'] == 1 ): ?><input type="checkbox" name='state' value="1" class="js-switch" checked />
	                        			<?php else: ?>
	                        				<input type="checkbox" name='state' value="1" class="js-switch" /><?php endif; ?>
	                        		</div>
								</div>
							</div>
                            <div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="orderby" id="orderby" value="<?php echo ($detail["orderby"]); ?>" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-2">
									...
									<a class="btn btn-danger" href="<?php echo U('Link/index');?>">取消</a>
								</div>
							</div>
						</form>
					</div>
