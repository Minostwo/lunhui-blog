					...
					<div class="ibox-content">
						...
						<input type="hidden" name="id" value="<?php echo ($detail["id"]); ?>" />							
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="username" id="username" value="<?php echo ($detail["username"]); ?>" class="form-control">
								</div>
							</div>												
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<textarea type="text" rows="5" name="content" id="content" class="form-control"><?php echo ((isset($detail["content"]) && ($detail["content"] !== ""))?($detail["content"]):''); ?></textarea>
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="ip" id="ip" value="<?php echo (getIpaddr($detail["ip"])); ?>" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="from" id="from" value="<?php echo ($detail["from"]); ?>" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="add_time" id="add_time" value="<?php echo (date('Y年m月d日 H:i:s',$detail["add_time"])); ?>" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="email" id="email" value="<?php echo ($detail["email"]); ?>" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<script type="text/plain" id="editor" name="c_content" style="width:78%;height:200px;"><?php echo (stripslashes(htmlspecialchars_decode($detail["c_content"]))); ?></script>
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="c_name" id="c_name" value="<?php echo ($admin["username"]); ?>" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
