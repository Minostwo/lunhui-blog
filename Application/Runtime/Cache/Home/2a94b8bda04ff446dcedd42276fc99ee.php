						...
						<div class="xs12">
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="clearfix articlebox">
									<div class="detail_a">
										...
										<div class="a_tuijian">
											<?php if($vo["a_red"] == 1): ?><img src="/lunhui/Public/Home/images/tuijian.gif" style="width:70px" /><?php endif; ?>
										</div>
									</div>
									<div class="article">
											 ...
											 <li>
									                <a href="<?php echo U('Article/index',array('a_id'=>$vo['a_id']));?>">
											            <div class="icourse-img">
											            	<img src="/lunhui/Uploads/<?php echo ($vo["photo"]); ?>" onerror="this.src='/lunhui/Public/Home/images/default.jpg'" class="img" title="<?php echo ($v["a_title"]); ?>" width="100%" height="200px" />
											            </div>
